...
namespace HLBox17b.Olv
{
    ...
    public class HeaderControl : NativeWindow
    {
        ...
        protected Rectangle DrawFilterIndicator(Graphics g, Rectangle r) {
            ...
            Image indicator = HLBox17b.Properties.Resources.ColumnFilterIndicator;
            int x = r.Right - width;
		...
		if (HLBox17b.Properties.Resources.ColumnFilterIndicator == null || r.Width < 48)
                return 0;
		return HLBox17b.Properties.Resources.ColumnFilterIndicator.Width + 1;
        }
