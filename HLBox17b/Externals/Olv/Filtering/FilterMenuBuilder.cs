...
namespace HLBox17b.Olv
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
		static public Bitmap ClearFilteringImage = HLBox17b.Properties.Resources.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
		static public Bitmap FilteringImage = HLBox17b.Properties.Resources.Filtering;
